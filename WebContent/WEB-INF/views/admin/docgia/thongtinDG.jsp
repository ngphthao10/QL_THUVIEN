		...
		<div class = "main-content col-md-10" >
          ...
          <div class="container" id="btnThongTin">
            <table class="table table-hover table-bordered mt-4">
              ...
              <tr>
                <th class="col-4">Ngày sinh</th>
                <td>${docgiaDTO.docgia.formattedNgaySinh}</td>
              </tr>

              <tr> 
                <th class="col-4">Loại độc giả</th>
              ...
              <tr>
                <th class="col-4">Ngày lập thẻ</th>
                <td>${docgiaDTO.docgia.formattedNgayLapThe}</td>
              </tr>

              <tr>
                <th class="col-4">Ngày hết hạn</th>
                <td>${docgiaDTO.docgia.formattedNgayHetHan}</td>
              </tr>

              <tr>
                <th class="col-4">Tổng nợ hiện tại</th>
          ...
          <div class="row">
	          ...
	          <div class="button-container">
	            ...
	            <%@include file="/WEB-INF/views/docgia/editThongTin.jsp"%>
