	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="main-content col-md-10">
				<div class="container">
	                <div class="row">
	                  <div class="col-6 mt-4 ps-4 mt-4"><h3>QUẢN LÝ THỂ LOẠI</h3></div>
	                  <div class="col-6 mt-4">
	                  <form:form class="d-flex" role="search" method="POST"
							action="sach/theloai/insert.htm" modelAttribute="theloai">
							<form:input path="TenTheLoai" type="text" class="form-control me-2"
	              ...
	              <!-- Khai báo pagedListHolder với param p -->
	                ...
	                <table class="table table-hover table-bordered mt-3"  style="vertical-align: middle;">
	                  <thead>
	                    <tr>
