						...
						<div class="modal-body">
							<form:form class="was-validated" action="sach/tuasach/insertTS.htm" method="post" modelAttribute="tuasachdto">
								<div class="mb-3">
									...
									<form:input path="tuasach.TenTuaSach" class="form-control is-invalid" id="tenTuaSachInput" required="true" placeholder="Tên tựa sách"/>
									<div class="invalid-feedback"> 
										<form:errors  path="tuasach.TenTuaSach" />
									</div>
								</div>
								<div class="mb-3">
	...
	<script>
			...
			<script>
			    window.onload = function() {
			        if (window.location.href.includes("insertTS")) {
