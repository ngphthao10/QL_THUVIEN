		...
		<div class="row">
							...
							<form:form class="was-validated"
								...
								<div class="row">
									...
									<div class="col-sm-4">
										<div class="mb-3">
											...
											<form:input path="sach.NamXB" class="form-control is-invalid"
												id="validationTextarea" placeholder="Năm xuất bản" required="true" />
											<div class="invalid-feedback"> 
												<form:errors  path="sach.NamXB" />
											</div>
										</div>
									</div>
								</div>
									...
									<div class="col-sm-8">
										<div class="mb-3">
											<label for="validationTextarea" class="form-label">Nhà
												xuất bản*</label> 
											<form:input path="sach.NhaXB" class="form-control is-invalid"
												id="validationTextarea" placeholder="Nhà xuất bản" required="true" />
											<div class="invalid-feedback"> 
												<form:errors  path="sach.NhaXB" />
											</div>
										</div>
									</div>
									<div class="col-sm-4">
										<div class="mb-3">
											<label for="validationTextarea" class="form-label">Đơn
												giá*</label>
										    <form:input path="sach.DonGia" class="form-control is-invalid" id="donGia"
												placeholder="Đơn vị: VNĐ" required="true" onchange="tinhThanhTien()" />
											<div class="invalid-feedback"><form:errors  path="sach.DonGia" /></div>
										</div>
									</div>
								</div>
								...
								<div class="row">
									...
									<div class="col-sm-6 mb-3">
										...
										<form:input path="ctpn.SoLuongNhap" class="form-control is-invalid"
			...
			<script>
				window.onload = function showModal() {
					if (window.location.href.includes("insertSachMoi")) {
