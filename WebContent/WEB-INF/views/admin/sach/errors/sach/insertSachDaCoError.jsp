		...
		<div class="row">
				...
				<div
					...
					<div class="modal-content ">
						<div class="modal-header">
							<h1 class="modal-title fs-5" id="exampleModalLabel2">Phiếu nhập
								sách</h1>
						...
						<div class="modal-body">
							<form:form class="was-validated"
								action="sach/sach/insertSachDaCo.htm" method="post"
								modelAttribute="sachDTO">
								<div class="container-fluid">
									<div class="row">
										<div class="mb-3">
											<label for="validationTextarea" class="form-label ">Ngày
												nhập sách:</label> <form:input path="pns.NgayNhap"
												class="form-control datepicker" placeholder="Ngày nhập sách"
												required = "true" />
									...
									<div class="row mb-3">
										<div class="col-sm-9">
											<label for="validationTextarea" class="form-label ">Sách
												nhập:</label>
										...
										<div class="col-sm-3">
											<label for="validationTextarea" class="form-label ">Số
												lượng nhập:</label> <form:input path="ctpn.SoLuongNhap"
												class="form-control is-invalid" id="soLuongNhap"
												placeholder="Số lượng nhập" required="true"/>
											<div class="invalid-feedback"><form:errors path="ctpn.SoLuongNhap"/></div>
			...
			<script>
				window.onload = function showModal() {
					if (window.location.href.includes("insertSachDaCo")) {
